...
const ClassesCard = ({ item }) => {
    ...
    return (
        <div className='bg-white transition-all duration-300 ease-in-out hover:shadow-custom rounded-md flex flex-col justify-between cursor-pointer relative hover:-translate-y-4'>
            ...
            <div className='px-5 pb-5'>
                ...
                {
                    pathname === '/classes' && <div className='flex-1 flex items-end justify-center mt-5'>
